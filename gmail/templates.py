...
from linkedin.icp_outbound import _sender_blocks, safe_company_name
...
def _load() -> dict:
    store = json.loads(TEMPLATES_PATH.read_text())
    sender_blocks, _is_v2 = _sender_blocks(store)
