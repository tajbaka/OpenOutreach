...
ENV_VARS: tuple[EnvVar, ...] = (
    ...
    EnvVar("ENABLE_STALE_INVITE_WITHDRAWAL", False, False, "false", "feature_flags",
           "Withdraw stale project-sent invitations after the local daily connect cap."),
    ...
    EnvVar("STALE_INVITE_AGE_DAYS", False, False, "30", "limits",
           "Minimum age in days before a project-sent invitation is withdrawable."),
    EnvVar("STALE_INVITE_WITHDRAWAL_DAILY_LIMIT", False, False, "25", "limits",
           "Maximum confirmed invitation withdrawals per sender per local day."),
