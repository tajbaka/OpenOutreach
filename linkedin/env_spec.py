...
ENV_VARS: tuple[EnvVar, ...] = (
    ...
    EnvVar("DISCOVERY_TIMEZONE", False, False, "America/Toronto", "discovery",
           "IANA timezone for discovery windows and sender daily limits."),
    EnvVar("DISCOVERY_WEEKDAY_START_HOUR", False, False, "18", "discovery",
           "First weekday hour when profile discovery may run."),
    EnvVar("DISCOVERY_WEEKDAY_END_HOUR", False, False, "21", "discovery",
           "Last weekday hour when profile discovery may run."),
    EnvVar("DISCOVERY_RUN_ON_REST_DAYS", False, False, "true", "discovery",
           "Allow discovery during its configured rest-day window."),
    EnvVar("DISCOVERY_REST_DAY_START_HOUR", False, False, "11", "discovery",
           "First rest-day hour when profile discovery may run."),
    EnvVar("DISCOVERY_REST_DAY_END_HOUR", False, False, "16", "discovery",
           "Last rest-day hour when profile discovery may run."),
