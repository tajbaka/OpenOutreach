...
DISCOVERY_MAX_SECTIONS_PER_RUN = int(
    os.getenv("DISCOVERY_MAX_SECTIONS_PER_RUN", "12"),
)
DISCOVERY_MAX_SCROLL_ROUNDS_PER_RUN = int(
    os.getenv("DISCOVERY_MAX_SCROLL_ROUNDS_PER_RUN", "12"),
)
DISCOVERY_MAX_CONSECUTIVE_EMPTY_SCROLLS = int(
    os.getenv("DISCOVERY_MAX_CONSECUTIVE_EMPTY_SCROLLS", "3"),
)
DISCOVERY_MAX_PROFILE_RECOMMENDATIONS_PER_VISIT = int(
    os.getenv("DISCOVERY_MAX_PROFILE_RECOMMENDATIONS_PER_VISIT", "20"),
)
...
LINKEDIN_FEED_COLLECTION_CATCHUP_DAYS = int(
    os.getenv("LINKEDIN_FEED_COLLECTION_CATCHUP_DAYS") or 14,
)
LINKEDIN_FEED_COLLECTION_MAX_POSTS = int(
    os.getenv("LINKEDIN_FEED_COLLECTION_MAX_POSTS") or 1000,
)
LINKEDIN_FEED_COLLECTION_STOP_AFTER_SEEN = int(
    os.getenv("LINKEDIN_FEED_COLLECTION_STOP_AFTER_SEEN") or 15,
)
LINKEDIN_FEED_COLLECTION_STOP_AFTER_STALE = int(
    os.getenv("LINKEDIN_FEED_COLLECTION_STOP_AFTER_STALE") or 25,
)
